...
<COWORK>/previdenciario/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "previdenciario" / "cowork-state.json"
    ...
    pending_path = cowork / "previdenciario" / ".memory-evolver-pending.json"
